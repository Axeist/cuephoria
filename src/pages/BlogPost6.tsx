        ...
        <div className="container mx-auto px-4 relative z-10 max-w-4xl">
          ...
          <header className="mb-12">
            ...
            <div className="relative rounded-3xl overflow-hidden mb-8 group">
              <img
                src="https://images.unsplash.com/photo-1604167719670-2a7703469f8d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
